 ...
 * the mark cannot swap under the admin after first paint.
 *
...
const LogoMark = ({ className = "", rounded = "rounded-lg", textClassName = "text-base" }) => {
  ...
  if (url) {
    // Painted as a small tile in the sidebar and on the login card — no reason
    // to download the full-size upload for it.
    return (
      <img
